...
namespace ProceduralPlanets
{
    ...
    public class SolidPlanet : Planet
    {
        ...
        ProceduralMaterial _proceduralMaterialBiome1;
        ProceduralMaterial _proceduralMaterialBiome2;
        ProceduralMaterial _proceduralMaterialPolarIce;
        ProceduralMaterial _proceduralMaterialCities;
        ProceduralMaterial _proceduralMaterialClouds;
        ProceduralMaterial _proceduralMaterialLava;

        // Textures used by the planet
        ProceduralTexture _textureMaps;
        ProceduralTexture _textureBiome1DiffSpec;
        ProceduralTexture _textureBiome1Normal;
        ProceduralTexture _textureBiome2DiffSpec;
        ProceduralTexture _textureBiome2Normal;
        ProceduralTexture _textureIceDiffuse;
        ProceduralTexture _textureCities;
        ProceduralTexture _textureClouds;
        ProceduralTexture _textureLavaDiffuse;
        ProceduralTexture _textureLavaFlow;
        ...
        protected override void Awake()
        {
            ...
            AddPropertyFloat("alienization", "Alienization*", 0.0f, 1.0f, true, false, 2, false, new string[] { "Biome1", "Biome2" }, new ProceduralMaterial[] { _proceduralMaterialBiome1, _proceduralMaterialBiome2 }, "Biome_Alienization", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
        ...
        public override void UpdateProceduralTexture(string _textureName)
        {
            ...
            if (_textureName == "All" || _textureName == "Maps")
            {
                ...
                _proceduralMaterialMaps.SetProceduralVector("$outputsize", new Vector4(_lodComposition + 4, _lodComposition + 4, 0, 0));
            ...
            if (_textureName == "All" || _textureName == "Biome1")
            {
                ...
                _proceduralMaterialBiome1.SetProceduralVector("$outputsize", new Vector4(_lodBiome + 4, _lodBiome + 4, 0, 0));
                _proceduralMaterialBiome1.RebuildTextures();
                _textureBiome1DiffSpec = _proceduralMaterialBiome1.GetGeneratedTexture(_proceduralMaterialBiome1.name + "_Diffuse");
                _textureBiome1Normal = _proceduralMaterialBiome1.GetGeneratedTexture(_proceduralMaterialBiome1.name + "_Normal");
            ...
            if (_textureName == "All" || _textureName == "Biome2")
            {
                ...
                _proceduralMaterialBiome2.SetProceduralVector("$outputsize", new Vector4(_lodBiome + 4, _lodBiome + 4, 0, 0));
                _proceduralMaterialBiome2.RebuildTextures();
                _textureBiome2DiffSpec = _proceduralMaterialBiome2.GetGeneratedTexture(_proceduralMaterialBiome2.name + "_Diffuse");
                _textureBiome2Normal = _proceduralMaterialBiome2.GetGeneratedTexture(_proceduralMaterialBiome2.name + "_Normal");
            ...
            if (_textureName == "All" || _textureName == "Cities")
            {
                ...
                _proceduralMaterialCities.SetProceduralVector("$outputsize", new Vector4(_lodCities + 4, _lodCities + 4, 0, 0));
                _proceduralMaterialCities.RebuildTextures();
                _textureCities = _proceduralMaterialCities.GetGeneratedTexture(_proceduralMaterialCities.name + "_Diffuse");
            ...
            if (_textureName == "All" || _textureName == "Lava")
            {
                ...
                _proceduralMaterialLava.SetProceduralVector("$outputsize", new Vector4(_lodLava + 4, _lodLava + 4, 0, 0));
                _proceduralMaterialLava.RebuildTextures();
                _textureLavaDiffuse = _proceduralMaterialLava.GetGeneratedTexture(_proceduralMaterialLava.name + "_Diffuse");
                _textureLavaFlow = _proceduralMaterialLava.GetGeneratedTexture(_proceduralMaterialLava.name + "_Flow");
            ...
            if (_textureName == "All" || _textureName == "Clouds")
            {
                ...
                _proceduralMaterialClouds.SetProceduralVector("$outputsize", new Vector4(_lodClouds + 4, _lodClouds + 4, 0, 0));
                _proceduralMaterialClouds.RebuildTextures();
                _textureClouds = _proceduralMaterialClouds.GetGeneratedTexture(_proceduralMaterialClouds.name + "_Diffuse");
            ...
            if (_textureName == "All" || _textureName == "PolarIce")
            {
                ...
                _proceduralMaterialPolarIce.SetProceduralVector("$outputsize", new Vector4(_lodPolarIce + 4, _lodPolarIce + 4, 0, 0));
                _proceduralMaterialPolarIce.RebuildTextures();
                _textureIceDiffuse = _proceduralMaterialPolarIce.GetGeneratedTexture(_proceduralMaterialPolarIce.name + "_Diffuse");
