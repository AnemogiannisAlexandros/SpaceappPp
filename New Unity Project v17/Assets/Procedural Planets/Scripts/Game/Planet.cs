...
namespace ProceduralPlanets
{
    ...
    public abstract class Planet : MonoBehaviour
    {
        ...
        protected virtual void SetProceduralMaterialFloats(string _map, ProceduralMaterial _proceduralMaterial)
        {
            ...
            foreach (KeyValuePair<string, PropertyFloat> _p in _dictionaryFloats)
            {
                if (_p.Value.proceduralTextures != null)
                {
                    if (_p.Value.proceduralTextures.Contains(_map))
                    {
                        ...
                        _proceduralMaterial.SetProceduralFloat(_p.Value.shaderProperty, _value);
                    }
                }
            }
        }
        ...
        /// 
        /// Refer to the ProceduralPlanets_Properties.PDF documentation for a full reference of property names.
        /// The reference also states if a property is a shader feature (fast to animate) or which procedural materials need to be rebuilt (slow).        
        /// </summary>
        /// <param name="_key">The camelCase name of a property float - refer to the ProceduralPlanets_Properties.PDF documentation for a full reference of property names.</param>
        /// <param name="_source">Source float value.</param>
        /// <param name="_destination">Destination/Target float value.</param>
        /// <param name="_duration">Time it should take for the animation.</param>
        /// <param name="_delay">Delay after which the animation starts.</param>
        /*! \code{.cs}
        ...
        \endcode
        */
        public void AnimateFloat(string _key, float _source, float _destination, float _duration, float _delay)
        {
