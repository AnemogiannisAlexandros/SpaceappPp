...
namespace ProceduralPlanets
{
    ...
    public class GasPlanet : Planet
    {
        ...
        ProceduralMaterial _proceduralMaterialMaps;

        // Textures used by the planet
        ProceduralTexture _textureMaps;
        ProceduralTexture _texturePaletteLookup;
        ProceduralTexture _textureBodyNormal;
        ProceduralTexture _textureCapNormal;
        ...
        protected override void Awake()
        {
            ...
            AddPropertyFloat("horizontalTiling", "Horizontal Tiling", 1, 10, false, true, 5, false, new string[] { "StormMask" }, _material, "_HTiling", PropertyFloat.Method.VALUE, PropertyFloat.DataType.INT);
            ...
            AddPropertyFloat("turbulence", "Turbulence*", 0.0f, 0.2f, true, false, 20, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Turbulence", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("turbulenceScale", "Turbulence Scale*", 1, 10, false, false, 30, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Turbulence_Scale", PropertyFloat.Method.VALUE, PropertyFloat.DataType.INT);
            AddPropertyFloat("turbulenceDisorder", "Turbulence Disorder*", 0.0f, 1.0f, true, false, 40, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Turbulence_Disorder", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("separation", "Separation*", 0.0f, 1.0f, true, false, 50, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Separation", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("smoothness", "Smoothness*", 0.0f, 100.0f, true, false, 60, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Smoothness", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("blurriness", "Blurriness*", 0.0f, 16.0f, true, false, 70, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Blurriness", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("palette", "Palette*", 1, 8, false, true, 80, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Palette", PropertyFloat.Method.VALUE, PropertyFloat.DataType.INT);
            AddPropertyFloat("detail", "Detail*", 0.0f, 1.0f, true, false, 90, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Detail", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("detailOffset", "Detail Offset*", 0.0f, 1.0f, true, false, 100, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Detail_Offset", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("contrast", "Contrast*", -0.6f, 0.6f, true, false, 110, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Contrast", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("hue", "Hue*", 0.0f, 1.0f, true, false, 120, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Hue", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("saturation", "Saturation*", 0.0f, 1.0f, true, false, 130, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Saturation", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("brightness", "Brightness*", 0.0f, 1.0f, true, false, 150, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Brightness", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            ...
            AddPropertyFloat("stormSquash", "Storm Squash*", 0.0f, 1.0f, true, false, 230, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Storm_Squash", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            ...
            AddPropertyFloat("stormScale", "Storm Scale*", 0.0f, 1.0f, true, false, 260, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Storm_Scale", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
            AddPropertyFloat("stormNoise", "Storm Noise*", 0.0f, 1.0f, true, false, 270, false, new string[] { "Maps" }, new ProceduralMaterial[] { _proceduralMaterialMaps }, "Storm_Noise", PropertyFloat.Method.LERP, PropertyFloat.DataType.FLOAT);
        ...
        public void RebuildTextures(bool _force = false)
        {
            ...
            {
                // Calculate number of possible storm mask positions based on tiling and set the new maxValue for stormMaskIndex
                /*
                float _oldIndexNormalized = 0;
                PropertyFloat _pf = _dictionaryFloats["stormMaskIndex"];
                if (_pf.overrideRandom)
                    _oldIndexNormalized = _pf.value / _pf.maxValue;

                int _newMaxValue = (int)(_dictionaryFloats["verticalTiling"].value * _dictionaryFloats["horizontalTiling"].value);
                _pf.maxValue = _newMaxValue;
                if (!_pf.overrideRandom)
                    SetPropertyFloat("stormMaskIndex");
                else
                    OverridePropertyFloat("stormMaskIndex", _newMaxValue * _oldIndexNormalized);
                */
        ...
        public override void UpdateProceduralTexture(string _textureName)
        {
            ...
            if (_textureName == "All" || _textureName == "Maps")
            {
                ...
                _proceduralMaterialMaps.SetProceduralVector("$outputsize", new Vector4(_lodGas + 4, _lodGas + 4, 0, 0));
                _proceduralMaterialMaps.RebuildTextures();
                _textureMaps = _proceduralMaterialMaps.GetGeneratedTexture(_proceduralMaterialMaps.name + "_Diffuse");
                _texturePaletteLookup = _proceduralMaterialMaps.GetGeneratedTexture(_proceduralMaterialMaps.name + "_Palette_Diffuse");
                _textureBodyNormal = _proceduralMaterialMaps.GetGeneratedTexture(_proceduralMaterialMaps.name + "_BodyNormal");
                _textureCapNormal = _proceduralMaterialMaps.GetGeneratedTexture(_proceduralMaterialMaps.name + "_CapNormal");
