...
namespace ProceduralPlanets
{
    ...
    public class PlanetManager : Singleton<PlanetManager>
    {
        ...
        */
        ...
        public List<ProceduralMaterial> solidBiomeMaterials = new List<ProceduralMaterial>(0);
        ...
        public List<ProceduralMaterial> gasMaterials = new List<ProceduralMaterial>(0);
        ...
        public List<ProceduralMaterial> substanceDuplicates = new List<ProceduralMaterial>(0);
        ...
        private struct SubstanceAllicationEntry
        {
            ...
            public SubstanceAllicationEntry(ProceduralMaterial _key, GameObject _gameObject, string _materialName)
            {
        ...
        public static void Initialize()
        {
            ...
            Instance.RecreateGenericBlueprint();
        ...
        */
        ...
        public ProceduralMaterial GetUniqueProceduralMaterial(ProceduralMaterial _proceduralMaterial, GameObject _gameObject, string _mapName)
        {
            ...
            Dictionary<ProceduralMaterial, SubstanceAllicationEntry> _tempDictionary = new Dictionary<ProceduralMaterial, SubstanceAllicationEntry>(0);
            ...
            foreach (ProceduralMaterial _p in substanceDuplicates)
            {
        ...
        /// <summary>
        /// Recreates a generic blueprint used to add rings to planet without ring blueprint. Public so editor script can call this method.
        /// </summary>
        public void RecreateGenericBlueprint()
        {
            if (Instance.transform.Find(GENERIC_PLANET_BLUEPRINT_NAME) != null)
                DestroyImmediate(Instance.transform.Find(GENERIC_PLANET_BLUEPRINT_NAME).gameObject);
