...
namespace ProceduralPlanets
{
    ...
    public class Ring : MonoBehaviour
    {
        ...
        private ProceduralTexture _textureRing;
        ...
        public void UpdateProceduralTexture()
        {
            ...
            _textureRing = proceduralMaterial.GetGeneratedTexture(proceduralMaterial.name + "_Diffuse");
            _material[0].SetTexture("_MainTex", _textureRing);
            _material[1].SetTexture("_MainTex", _textureRing);
            _dictionaryMaterials["ringMaterial"].GetPropertyMaterial().RebuildTextures();
        }
